 ...
 * @author   Romain Ruaud <romain.ruaud@smile.fr>
 */
class MassDisapprove extends AbstractOffer
{
    /**
     * {@inheritdoc}
     */
    public function execute()
    {
        ...
        foreach ($collection as $item) {
            ...
            $sellerOffer->setData('request_status', \Lofmp\SellerOffer\Model\SellerOffer::STATUS_DISAPPROVED);
            $this->sellerOfferRepository->saveSellerOffer($sellerOffer);
        }
        $this->messageManager->addSuccess(__('A total of %1 record(s) have been disapproved.', $collectionSize));
